...
public class Server {
    ...
    private Vector<ClientHandler> allClients;//все зарегистрированные клиенты (и в сети и не в сети)
    ...
    public Server(){
        try(ServerSocket serverSocket = new ServerSocket(8189)){
            ...
            authService.connect();
            authService.getAllRegistredUsers(allClients);
    ...
    public void subscribe(ClientHandler clientHandler){
        ...
        allClients.forEach((ConnectionList) c ->{});
